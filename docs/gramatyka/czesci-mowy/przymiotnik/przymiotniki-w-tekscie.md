...
<div class="reading-panel">
  ...
  <div class="reading-text">
    ...
    <p><span class="sentence-no">6.</span> Nowa właścicielka, Helena, od razu zauważyła <span class="word-token adj-quality">niezwykły</span> spokój tego miejsca.</p>
    ...
    <p><span class="sentence-no">14.</span> Litery były <span class="word-token adj-quality">słabo</span> widoczne, lecz napis pozostał <span class="word-token adj-quality">czytelny</span>.</p>
    ...
    <p><span class="sentence-no">16.</span> W bibliotece Helena odkryła <span class="word-token adj-quality">najstarszy</span> mebel w całym domu.</p>
    <p><span class="sentence-no">17.</span> Był to <span class="word-token adj-relation">orzechowy</span> sekretarzyk z <span class="word-token adj-quality">ukrytą</span> szufladą.</p>
    ...
    <p><span class="sentence-no">20.</span> Kolejne strony były <span class="word-token adj-quality">bardziej szczegółowe</span> i <span class="word-token adj-quality">znacznie dłuższe</span>.</p>
    <p><span class="sentence-no">21.</span> Opisywały <span class="word-token adj-relation">miejskie</span> wydarzenia oraz <span class="word-token adj-quality">codzienne</span> życie mieszkańców.</p>
    <p><span class="sentence-no">22.</span> Helena czytała o <span class="word-token adj-quality">dawnych</span> targach, <span class="word-token adj-quality">głośnych</span> festynach i <span class="word-token adj-quality">zimowych</span> burzach.</p>
    <p><span class="sentence-no">23.</span> Najbardziej zainteresowała ją historia <span class="word-token adj-quality">zaginionego</span> ogrodnika.</p>
    <p><span class="sentence-no">24.</span> Według notesu był on <span class="word-token adj-quality">najlepszym</span> znawcą <span class="word-token adj-relation">miejscowych</span> roślin.</p>
    ...
    <p><span class="sentence-no">30.</span> Prowadziły do <span class="word-token adj-quality">najgęstszej</span> części ogrodu.</p>
    ...
    <p><span class="sentence-no">32.</span> Za furtką znajdował się <span class="word-token adj-quality">węższy</span> i <span class="word-token adj-quality">ciemniejszy</span> ogród.</p>
    ...
    <p><span class="sentence-no">34.</span> Powietrze było <span class="word-token adj-quality">chłodniejsze</span> niż przy domu.</p>
    <p><span class="sentence-no">35.</span> Na środku stała <span class="word-token adj-relation">kamienna</span> ławka z <span class="word-token adj-quality">wyrytym</span> zdaniem.</p>
    ...
    <p><span class="sentence-no">40.</span> Najgrubsza księga miała <span class="word-token adj-colour">zieloną</span> okładkę i <span class="word-token adj-colour">czarne</span> brzegi.</p>
    <p><span class="sentence-no">41.</span> Zawierała <span class="word-token adj-quality">dokładne</span> opisy każdej rośliny.</p>
    <p><span class="sentence-no">42.</span> Ostatni rozdział był <span class="word-token adj-quality">krótszy</span> od pozostałych.</p>
    ...
    <p><span class="sentence-no">45.</span> Po wielu latach jego decyzja wydawała się <span class="word-token adj-quality">rozsądniejsza</span> niż wcześniej.</p>
    ...
    <p><span class="sentence-no">48.</span> Najpiękniejsze kwiaty wyrosły przy <span class="word-token adj-relation">kamiennej</span> ławce.</p>
    <p><span class="sentence-no">49.</span> Dom stał się <span class="word-token adj-quality">jaśniejszy</span>, <span class="word-token adj-quality">cieplejszy</span> i bardziej <span class="word-token adj-quality">gościnny</span>.</p>
    <p><span class="sentence-no">50.</span> Mieszkańcy uznali ogród Heleny za <span class="word-token adj-quality">najbardziej niezwykłe</span> miejsce w całym miasteczku.</p>
  </div>
</div>
